...
# ------------------------------------------------------------------------------ 
 diagnoseDiscardCoverage <- function(
    census,
...
diagnosis <- diagnoseDiscardCoverage(census)

diagnosis$diagnosis |> headtail()
diagnosis$heatmap
diagnosis$bubbles
diagnosis$gap_table |> headtail()
